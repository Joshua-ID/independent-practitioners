      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 sm:gap-8 gap-3">
          {services.map((service, index) => (
            <div
              key={index}
              className="group bg-white p-8 rounded-2xl shadow-md active:shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:scale-95 sm:hover:scale-100 border-2 border-transparent hover:border-purple-600 min-h-[280px] flex flex-col"
            >
